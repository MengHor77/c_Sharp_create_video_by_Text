...
namespace c_Sharp_video
{
    class Program
    {
        ...
        {
            string txtFile = @"D:\c_Sharp_video\c_Sharp_video\The_Secret_Garden_of_Willowbrook.txt";
            ...
            string outputVideo = @"D:\c_Sharp_video\c_Sharp_video\The_Secret_Garden_of_Willowbrook.mp4";
